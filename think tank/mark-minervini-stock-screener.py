...
# replace any tickers that have a '.' with a '-'. Currently there are none, but
# in the future it may be the case that 'si' returns a ticker with a '.' in it
tickers = [item.replace(".", "-") for item in tickers]
index_used = '^GSPC' # index symbol for S&P 500
...
# filepath = r"C:\Users\Andrew.Canaan\source\repos\Fintech-Project\think tank\RichardStocks.xlsx"
