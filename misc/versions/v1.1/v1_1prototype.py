...
for ind in listings.index:
    ...
    if screen_config['Current Price']['active'] == True:
        print(f"Checking most recent Closing Price for {listings['Symbol'][ind]} against filter...")
        if daily_price_history is not None:
    ...
    if screen_config['Volume']['active'] == True:
        print(f"Checking Volume for {listings['Symbol'][ind]} against filter...")
        if daily_price_history is not None:
    ...
    if screen_config['Market Cap']['active'] == True:
        print(f"Checking Market Cap for {listings['Symbol'][ind]} against filter...")
    ...
    if screen_config['EPS']['active'] == True:
        print(f"Checking EPS for {listings['Symbol'][ind]} against filter...")
        if quarterly_company_earnings is not None:
    ...
    if screen_config['P/E']['active'] == True:
        print(f"Checking P/E for {listings['Symbol'][ind]} against filter...")
        if company_overview is not None:
    ...
    if screen_config['P/E/G']['active'] == True:
        print(f"Checking P/E/G for {listings['Symbol'][ind]} against filter...")
        if company_overview is not None:
    ...
    if screen_config['Beta']['active'] == True:
        print(f"Checking Beta for {listings['Symbol'][ind]} against filter...")
        if company_overview is not None:
    ...
    if screen_config['Dividends Y/N']['active'] == True:
        print(f"Checking dividend status for {listings['Symbol'][ind]}...")
        if company_overview is not None:
